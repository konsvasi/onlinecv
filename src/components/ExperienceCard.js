			...
			<div className="card-content">
					...
					<div className="timeline">
						...
						<div className="timeline-content">
							...
							<p className="subtitle">Software developer at the Greek ministry of Defence</p>
							<p>During my compulsory military service I was chosen to be part
								...
								for the Greek army that was used by the people in the army to better manages 
						...
						<div className="timeline-item">
							...
							<div className="timeline-content">
								...
								<p className="subtitle">Software developer at Seeburger AG</p>
						...
						<div className="timeline-item">
							...
							<div className="timeline-content">
								...
								<p>At my first developer job I worked with Javascript and NodeJs where my main task
						...
						<div className="timeline-item">
							...
							<div className="timeline-content">
								...
								<p>Graduated from one of the most renowned universities in the country. My main courses where: </p>
								<ul>
